...
import { Lib, Radio, Dics, Chart, Star, Type, Bxh, Plus } from "../utils/icon";

const SideBar = () => {
    return (
        <div className="w-[240px] h-screen flex flex-col justify-between" style={{ backgroundColor: "#231B2E" }}>
            <div>
                <nav>
                    <div className="w-full h-[70px] top-10 flex" style={{ padding: "0px 25px 0px 28px" }}>
                        <button><img src={logo} alt="" className="w-[120px] h-[40px]" /></button>
                    </div>
                </nav>
                <nav>
                    <ul>
            ...
            <button className=" flex items-center w-[240px] px-[21px] bg-[#231B2E] h-[54px] sidebar-divine">
                <div className=" text-gray-400 hover:text-white font-semibold text-[14px] flex items-center">
                    <Plus /> <span className="">Tạo Playlist mới</span>
                </div>
            </button>
        </div>
    )
