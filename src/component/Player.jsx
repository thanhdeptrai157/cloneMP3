...
const Player = ({ setIsShowRightSideBar}) => {
    ...
    const toggleRightSidebar = ()=>{
        setIsShowRightSideBar(flag => !flag)
    }
    const toggleLyric = ()=>{
        setIsShowLyric(flag => !flag)
    }
    useEffect(() => {
    ...
    return (
        ...
        <><div className="player-controls h-[87px] w-full bg-[#130C1C] fixed bottom-0 z-[1000] flex px-[20px]">
                ...
                <div className="info w-1/4">
                    ...
                    <button className="text-white" onClick={toggleLyric}>Lyric</button>
                </div>

            </div><Lyric isShowLyric={isShowLyric} setIsShowLyric={setIsShowLyric} currentTime={audio.currentTime}/></>
        )
        :null
    )
}
