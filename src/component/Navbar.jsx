...
const Navbar = () => {
    ...
    return (
        <div className={`navbar h-[70px] px-[59px] flex items-center fixed left-[240px] right-0 min-w-[660px] transition-all duration-500 ease-in-out z-50 ${scrolled ? 'bg-[#170F23] opacity-90' : 'bg-transparent opacity-100'}`}>
