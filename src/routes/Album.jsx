...
const Album = () => {
    ...
    return (
        <div className=''>
            <div className="mt-[135px] flex gap-10 album_container transition-all duration-300 ease-in-out px-[59px]" >
                    ...
                    <div className=' items-center info-album '>
                        ...
                        <div className='text-gray-500 text-[12px] font-semibold'>
                            ...
                            data?.artists?.map((artist, index) => (
                                <a href="" className="text-[#7C7883] hover:text-[#9B4DE0] text-[12px] font-medium "
                                    key={index}
                                >{artist.name}{index < data?.artists?.length - 1 && ', '}</a>
                            ))
                            }
                        </div>
                ...
                <div className="w-3/4 playlist-song">
                    ...
                    {songs?.map((song, index) => (
                        <Song2 song={song} handleClick={handleClick} isInAlbum={true} key={index}/>
                    ))}
            ...
            <h2 className='text-white text-[20px] font-bold mt-[100px] px-[59px]'>Nghệ Sĩ Tham Gia</h2>
            <div className={`flex ${data?.artists.length > 2 ? 'justify-between' : ""} mb-[300px] mt-5 px-[59px]`}>
                {
                    data?.artists.map((artist, index) => (
